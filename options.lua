BuilderMovementComponent = {
  MaxFlySpeed = 4800,         -- default: 1200.0
  MaxAcceleration = 8192,     -- default: 2048.0
  BrakingFrictionFactor = 40, -- default: 2.0
  -- BrakingFriction = 0,              -- default: 0.0
  -- BrakingSubStepTime = 0.03,        -- default: 0.030303031206131 (approximately)
  -- BrakingDecelerationFlying = 1000, -- default: 1000.0
}
